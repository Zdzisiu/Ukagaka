...
M-P functions include:
- Logs for storing notes.
- To-Do list.
- Customisable character.
- Customisable apparence.
- Showing statistics for other ghost and balloons.
...
Anything not included in this list is considers an bug and should to be immediately reported to A.R.I consultant.
